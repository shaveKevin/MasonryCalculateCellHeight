...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.tempCell.nameLabel.text= @"xxxx";
    self.tempCell.contentLabel.text = _dataArray [indexPath.row];
    CGFloat height = [self.tempCell.contentView systemLayoutSizeFittingSize:UILayoutFittingCompressedSize].height + 1;
    return height;
}
